...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    approach_title: Schema.Attribute.String;
    approaches: Schema.Attribute.Component<'shared.approaches', true>;
    careers_button_link: Schema.Attribute.String;
    careers_button_text: Schema.Attribute.String;
    careers_description: Schema.Attribute.Text;
    careers_title: Schema.Attribute.String;
    community_description: Schema.Attribute.Text;
    ...
    story_content: Schema.Attribute.Blocks;
...
export interface ApiCareersPageCareersPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    careers_email: Schema.Attribute.Email;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactDiscord: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    showAboutPage: Schema.Attribute.Boolean;
    ShowCareersPage: Schema.Attribute.Boolean;
    showNewsPage: Schema.Attribute.Boolean;
    showProjectsPage: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMainPageMainPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    featuredProject: Schema.Attribute.Relation<
      ...
      'api::project.project'
    >;
    featuredProjectGradientColour: Schema.Attribute.String &
      Schema.Attribute.CustomField<'plugin::color-picker.color'>;
    featuredProjectGradientEnabled: Schema.Attribute.Boolean;
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', true>;
    showCTASection: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNewsPageNewsPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tag: Schema.Attribute.Enumeration<
      ['Release', 'Devlog', 'Announcement', 'Studio', 'Media']
    >;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tag: Schema.Attribute.Enumeration<
      ['Released', 'Coming Soon', 'In Development', 'Alpha', 'Beta']
    >;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
